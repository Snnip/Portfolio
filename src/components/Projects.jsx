    ...
    <div
      ...
      <div>
        ...
        <article className="flex flex-col md:flex-row lg:w-3/4 lg:mx-auto items-center gap-10 md:gap-20 mt-14">
          ...
          <section>
            ...
            <button className="text-white rounded-lg px-5 py-2 text-center mt-6 text-lg transition ease-in-out delay-150 bg-cyan-500  hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300">
              <a
      ...
      <div>
        ...
        <article className="flex flex-col lg:w-3/4 lg:mx-auto  mt-14">
          ...
          <button className="text-white rounded-lg w-20 py-2 text-center mt-6 text-lg transition ease-in-out delay-150 bg-cyan-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300">
            <a
